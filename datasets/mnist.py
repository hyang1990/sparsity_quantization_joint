...
def get(batch_size, data_root='/tmp/public_dataset/pytorch', train=True, val=True, **kwargs):
    data_root = os.path.expanduser(os.path.join(data_root, 'datasets-data'))
    ...
    if train:
        train_loader = torch.utils.data.DataLoader(
            ...
            batch_size=batch_size, pin_memory=False, shuffle=True, **kwargs)
    ...
    if val:
        test_loader = torch.utils.data.DataLoader(
            ...
            batch_size=batch_size, pin_memory=False, shuffle=False, **kwargs)
